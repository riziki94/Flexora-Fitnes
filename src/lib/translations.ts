...
export const translations = {
  en: {
    ...
    "auth.ptPlanLabel": "PT Subscription",
    "auth.planBasisDesc": "Plans, chat, ranking, food scanning, music and competitions",
    "auth.planHybridDesc": "Everything in Basis + AI-PT, groups and competitions",
    "auth.planPremiumDesc": "Everything in Hybrid + live video, movement correction, breathing measurement and 1:1 PT",
    "auth.planPtDesc": "Profile, marketing, speed date and access to the client base",
    "auth.planTapHint": "Tap a plan and get everything in it — 1 month free, no commitment, first 100 spots",
  ...
  no: {
    ...
    "auth.ptPlanLabel": "PT-abonnement",
    "auth.planBasisDesc": "Planer, chat, ranking, matskanning, musikk og konkurranser",
    "auth.planHybridDesc": "Alt i Basis + AI-PT, grupper og konkurranser",
    "auth.planPremiumDesc": "Alt i Hybrid + live video, bevegelseskorreksjon, pustemåling og 1:1 PT",
    "auth.planPtDesc": "Profil, markedsføring, speed date og tilgang til kundebasen",
    "auth.planTapHint": "Trykk på et abonnement og få alt i det — 1 måned gratis, ingen binding, første 100",
